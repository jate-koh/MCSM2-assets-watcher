# Episode 1: Hero in Residence's Assets
---
...
Some assets may not be listed here, as they have not yet been found or documented.

## Example Format
Please follow this format if you wish to append / add more texture to the list:
- [`Asset ID 1`, `Asset ID 2`, ...] `Asset Name`
